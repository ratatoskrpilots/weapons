(function() {
  ...
  if (searchInput && navList) {
    ...
    document.getElementById('openProfileButton').addEventListener('click', function(event) {
      event.preventDefault();
      Util.toggleClass(sidebar, 'cd-side-nav--is-visible', false);
      Util.toggleClass(mobileNavTrigger, 'cd-nav-trigger--nav-is-visible', false);
    });
